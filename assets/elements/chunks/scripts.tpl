...
jQuery(document).ready(function($) {
	...
	var carouselMain = $(".waterwheel-carousel-main").waterwheelCarousel();
	...
	if (dwidth > 1170) {
	  ...
	  //Carousel main
	  carouselMain = $(".waterwheel-carousel-main").waterwheelCarousel({
		horizon: 320,
		horizonOffset: 60,
		horizonOffsetMultiplier: .7,
		separation: 220,
  ...
  $('#static .waterweel-nav .next').on('click', function() {
			carouselMain.next();
  });
  $('#static .waterweel-nav .prev').on('click', function() {
			carouselMain.prev();
  });
  $('#gallery .waterweel-nav.id_26 .next').on('click', function() {
			carousel.next();
  });
  $('#gallery .waterweel-nav.id_26 .prev').on('click', function() {
			carousel.prev();
  });
});
</script>
