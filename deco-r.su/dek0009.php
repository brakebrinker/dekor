...
<head>
    ...
    <title>Бриз - объёмные панели от ДЕКО•Р</title>
...
<section>
    ...
    <h1>Бриз - объёмные панели от "ДЕКО•Р"</h1>

    <p>"<strong>Бриз</strong>" - мелкий волнистый рисунок с плавными линиями</p>

    <p>Подходят для стилей: минимализм, скандинавский, конструктивизм</p>
...
<section>
    ...
    <img src="catalog/dek0009w-800.jpg" class="showbox" alt="Панели Бриз в белом цвете">

    <img src="catalog/dek0009wa-800.jpg" class="showbox" alt="Панели Бриз в белом цвете">

    <p>Панели, окрашенные белой краской</p>

    <img src="catalog/dek0009b-800.jpg" class="showbox" alt="Панели Бриз в коричневом цвете">

    <img src="catalog/dek0009ba-800.jpg" class="showbox" alt="Панели Бриз в коричневом цвете">

    <p>Панели, окрашенные коричневой краской</p>

    <img src="catalog/dek0009m-800.jpg" class="showbox" alt="Панели Бриз, покрытые морилкой">

    <img src="catalog/dek0009ma-800.jpg" class="showbox" alt="Панели Бриз, покрытые морилкой">
