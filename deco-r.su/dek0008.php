...
<head>
    ...
    <title>Барханы - объёмные панели от ДЕКО•Р</title>
...
<section>
    ...
    <h1>Барханы - объёмные панели от "ДЕКО•Р"</h1>

    <p>"<strong>Барханы</strong>" - крупный волнистый рисунок, напоминающий кору дерева</p>

    <p>Подходят для стилей: бунгало, кантри, шале</p>
...
<section>
    ...
    <img src="catalog/dek0008w-800.jpg" class="showbox" alt="Панели Барханы в белом цвете">

    <img src="catalog/dek0008wa-800.jpg" class="showbox" alt="Панели Барханы в белом цвете">

    <p>Панели, окрашенные белой краской</p>

    <img src="catalog/dek0008b-800.jpg" class="showbox" alt="Панели Барханы в коричневом цвете">

    <img src="catalog/dek0008ba-800.jpg" class="showbox" alt="Панели Барханы в коричневом цвете">

    <p>Панели, окрашенные коричневой краской</p>

    <img src="catalog/dek0008m-800.jpg" class="showbox" alt="Панели Барханы, покрытые морилкой">

    <img src="catalog/dek0008ma-800.jpg" class="showbox" alt="Панели Барханы, покрытые морилкой">
