...
<head>
    ...
    <title>Реликт - объёмные панели от ДЕКО•Р</title>
...
<section>
    ...
    <h1>Реликт - объёмные панели от "ДЕКО•Р"</h1>

    <p>"<strong>Реликт</strong>" - рисунок, имитирующий каменные отпечатки</p>

    <p>Подходят для стилей: готика, романо, эклектика</p>
...
<section>
    ...
    <img src="catalog/dek0006w-800.jpg" class="showbox" alt="Панели Реликт в белом цвете">

    <img src="catalog/dek0006wa-800.jpg" class="showbox" alt="Панели Реликт в белом цвете">

    <p>Панели, окрашенные белой краской</p>

    <img src="catalog/dek0006b-800.jpg" class="showbox" alt="Панели Реликт в коричневом цвете">

    <img src="catalog/dek0006ba-800.jpg" class="showbox" alt="Панели Реликт в коричневом цвете">

    <p>Панели, окрашенные коричневой краской</p>

    <img src="catalog/dek0006m-800.jpg" class="showbox" alt="Панели Реликт, покрытые морилкой">

    <img src="catalog/dek0006ma-800.jpg" class="showbox" alt="Панели Реликт, покрытые морилкой">
